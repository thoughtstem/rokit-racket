...
void LineRun(byte speed)
{
  ...
  {
    if (Sensor == S102)       {
      directionM1 = CCW;       //s102
      directionM2 = CW ;
      speedM1 = speed1 ;
      speedM2 = speed0;
    }
    else if (Sensor == S104)  {
      directionM1 = CCW;       //s104
      directionM2 = CW ;
      speedM1 = speed2 ;
      speedM2 = speed0;
    }
    else if (Sensor == S106)  {
      directionM1 = CCW;       //s106
      directionM2 = CW ;
      speedM1 = speed3 ;
      speedM2 = speed0;
    }
    else if (Sensor == S108)  {
      directionM1 = CCW;       //s108
      directionM2 = CW ;
      speedM1 = speed3 ;
      speedM2 = speed0;
    }
      ...
      directionM1 = CCW;       //s103
      directionM2 = CW ;
      speedM1 = speed0 ;
      speedM2 = speed1;
    }
    else if (Sensor == S105)  {
      directionM1 = CCW;       //s105
      directionM2 = CW ;
      speedM1 = speed0 ;
      speedM2 = speed2;
    }
    else if (Sensor == S107)  {
      directionM1 = CCW;       //s107
      directionM2 = CW ;
      speedM1 = speed0 ;
      speedM2 = speed3;
    }
    else if (Sensor == S109)  {
      directionM1 = CCW;       //s109
      directionM2 = CW ;
      speedM1 = speed0 ;
      speedM2 = speed3;
    }
    else if (Sensor == S111)  {
      directionM1 = CCW;       //s111
      directionM2 = CCW ;
      speedM1 = speed0 ;
      speedM2 = speed0;
    }
  ...
  SmartInventor.PreviousMillis = millis();
  while (!SmartInventor.TimeCheckMillis(800));
