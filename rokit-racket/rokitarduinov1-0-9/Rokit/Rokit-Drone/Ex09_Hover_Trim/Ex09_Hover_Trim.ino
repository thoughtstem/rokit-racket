...
void loop()
{
  ...
  else if (!bt8 && bt7 && !bt6 && !bt4 && !bt3 && !bt2 && !bt1)
  {
    ...
    SmartDroneControl.ButtonPreesHoldWait(17);  //button up wait
  }
  ...
  else if (!bt8 && !bt7 && !bt6 && !bt4 && !bt3 && bt2 && !bt1)
  {
    ...
    SmartDroneControl.ButtonPreesHoldWait(12);  //button up wait
  }
  ...
  else if (!bt8 && !bt7 && bt6 && !bt4 && !bt3 && !bt2 && !bt1)
  {
    ...
    SmartDroneControl.ButtonPreesHoldWait(18);  //button up wait
  }
  ...
  else if (!bt8 && !bt7 && !bt6 && !bt4 && bt3 && !bt2 && !bt1)
  {
    ...
    SmartDroneControl.ButtonPreesHoldWait(11);  //button up wait
  }
