/*****************************************************************
  ■ 드론 아날로그 센서 2개로 리모트 콘트롤처럼 조종하는 예제 
*******************************************************************/
...
void loop()
{
  ...
  {
    YAW = -1 * SmartDroneControl.AnalogScaleChange(analogValue3); // 회전
    THROTTLE  = SmartDroneControl.AnalogScaleChange(analogValue4); // 상하
    ROLL = -1 * SmartDroneControl.AnalogScaleChange(analogValue5); // 좌우
    PITCH = SmartDroneControl.AnalogScaleChange(analogValue6); // 전후
