/*=============================================================================
 * RoboLink - Smart Simulator 
 //2015-06-26 Simulator Make
 //2016-03-16 Simulator Modify (Receive Command - Motor,LED Action)
  =============================================================================*/
...
void loop()
{
  ...
  byte buttonState3 = digitalRead(dipSw3);
...
void DigitalSend()
{
  ...
  portD[7] = !digitalRead(dipSw1);
  portD[6] = !digitalRead(dipSw2);
  portD[5] = !digitalRead(dipSw3);
