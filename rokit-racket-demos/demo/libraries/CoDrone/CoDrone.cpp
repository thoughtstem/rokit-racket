            ...
            else if (receiveLength + 6 <= cmdIndex)
            {
              ...
              {                       	
                ...
                else if (receiveDtype ==  dType_Motor)//dron Motor
                {
                  ...
                  droneMotor[4] = dataBuff[6];
                	droneMotor[5] = dataBuff[7];
                  droneMotor[6] = dataBuff[8];
                	droneMotor[7] = dataBuff[9];    
                	
                	droneMotor[8] = dataBuff[10];
                	droneMotor[9] = dataBuff[11];
                  droneMotor[10] = dataBuff[12];
                	droneMotor[11] = dataBuff[13];    
                	 
                	droneMotor[12] = dataBuff[14];
                	droneMotor[13] = dataBuff[15];
                  droneMotor[14] = dataBuff[16];
                	droneMotor[15] = dataBuff[17];    
			  ...
			  { 			  		
			  	DEBUG_SERIAL.println("");                	                
					...
					DEBUG_SERIAL.println(" ]");
			  		...
			  		/*		  	
			  	long SumX0	= droneImageFlow[0];
			  	long SumX1	= droneImageFlow[1];
			  	long SumX2	= droneImageFlow[2];
			  	long SumX3	= droneImageFlow[3];
			  	
			  	long SumY0	= droneImageFlow[4];
			  	long SumY1	= droneImageFlow[5];
			  	long SumY2	= droneImageFlow[6];
			  	long SumY3	= droneImageFlow[7];
			  				*/  	
			  	
			  	long pressure	= ((dronePressure[3] << 32) |(dronePressure[2] << 16) |(dronePressure[1] << 8) | (dronePressure[0]  & 0xff));
    ...
    else if (receiveDtype ==  dType_Motor)
    {
			  ...
			  { 			  		
			  	DEBUG_SERIAL.println("");                	                
					...
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[4],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[5],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[6],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[7],HEX);
					DEBUG_SERIAL.print(", ");	
					DEBUG_SERIAL.print(droneMotor[8],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[9],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[10],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[11],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[12],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[13],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[14],HEX);
					DEBUG_SERIAL.print(", ");
					DEBUG_SERIAL.print(droneMotor[15],HEX);
										
			  	DEBUG_SERIAL.println(" ]");
			  	
			  	
			  	int m1_forward	= ((droneMotor[1] << 8) | (droneMotor[0]  & 0xff));
			  	int m1_reverse	= ((droneMotor[3] << 8) | (droneMotor[2]  & 0xff));
			  	 	
			  	int m2_forward	= ((droneMotor[5] << 8) | (droneMotor[4]  & 0xff));
			  	int m2_reverse	= ((droneMotor[7] << 8) | (droneMotor[6]  & 0xff));
			  	 	
			  	int m3_forward	= ((droneMotor[9] << 8) | (droneMotor[8]  & 0xff));
			  	int m3_reverse	= ((droneMotor[11] << 8) | (droneMotor[10]  & 0xff));
			  	 		 				  	 	
			  	int m4_forward	= ((droneMotor[13] << 8) | (droneMotor[12]  & 0xff));
			  	int m4_reverse	= ((droneMotor[15] << 8) | (droneMotor[14]  & 0xff));
