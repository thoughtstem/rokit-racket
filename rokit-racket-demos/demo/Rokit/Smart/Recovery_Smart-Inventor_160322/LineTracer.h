...
*/
    ...
    if((buttonState1 == HIGH)  && (buttonState2 == HIGH))  speed = 45;
    if((buttonState1 == LOW)  && (buttonState2 == HIGH))  speed = 70;
    if((buttonState1 == HIGH)  && (buttonState2 == LOW))  speed = 85;
    if((buttonState1 == LOW)  && (buttonState2 == LOW))  speed = 100; 
  }
  else
  {
